...
export default function PiePM25({
  data = [],
  isLoading = false,
  className = "",
}: {
  ...
  return (
    ...
    >
      ...
      <CardContent className="flex flex-col pt-4 items-center justify-center flex-grow overflow-visible">
        {isLoading ? (
      ...
      <CardFooter className="flex justify-center pt-3 text-sm text-muted-foreground">
        Distribution of total PM2.5 mass
      </CardFooter>
    </Card>
  );
}
