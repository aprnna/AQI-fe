...
// Dummy fallback data
const dummyData = [
  { Date: "January 2020", "NO2 Mean": 12, "CO Mean": 0.4 },
  { Date: "February 2020", "NO2 Mean": 10, "CO Mean": 0.35 },
  { Date: "March 2020", "NO2 Mean": 8, "CO Mean": 0.3 },
  { Date: "April 2020", "NO2 Mean": 9, "CO Mean": 0.28 },
  { Date: "May 2020", "NO2 Mean": 7, "CO Mean": 0.25 },
  { Date: "June 2020", "NO2 Mean": 7.5, "CO Mean": 0.24 },
  { Date: "July 2020", "NO2 Mean": 8.2, "CO Mean": 0.26 },
  { Date: "August 2020", "NO2 Mean": 8.1, "CO Mean": 0.27 },
  { Date: "September 2020", "NO2 Mean": 7.9, "CO Mean": 0.29 },
  { Date: "October 2020", "NO2 Mean": 9.5, "CO Mean": 0.33 },
  { Date: "November 2020", "NO2 Mean": 10.8, "CO Mean": 0.36 },
  { Date: "December 2020", "NO2 Mean": 12.2, "CO Mean": 0.38 },
];
...
export default function TimeAQI({
  data,
  isLoading = true,
  className = "",
}: {
